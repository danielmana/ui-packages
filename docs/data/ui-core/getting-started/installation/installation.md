...
# UI Core - Installation

<p class="description">Install UI Core</p>

UI Core is available as an [npm package](https://www.npmjs.com/package/@danielmana/ui-core).
...
```sh
npm install @danielmana/ui-icons
```
