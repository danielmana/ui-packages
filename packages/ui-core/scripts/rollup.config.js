...
const nestedFolder = {
  resolveId: (importee) => {
    if (importee.indexOf('@danielmana/ui-core/') === 0) {
      return resolveNestedImport('ui-core', importee);
    }
...
export default [
  {
    ...
    onwarn,
    output: {
      file: 'build/umd/ui-core.development.js',
      format: 'umd',
      name: 'UICore',
      globals,
    },
  ...
  },
  {
    ...
    onwarn,
    output: {
      file: 'build/umd/ui-core.production.min.js',
      format: 'umd',
      name: 'UICore',
      globals,
    },
